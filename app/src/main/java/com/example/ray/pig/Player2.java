...
public class Player2 extends ActionBarActivity {
    ...
    public void rollDice() {
        ...
        player1point.setText("P1: " + Integer.toString(totalpoint));
        TextView player2point = (TextView) findViewById(R.id.p2);
        player2point.setText("P2: " + Integer.toString(totalpoint2+roundpoint));
        if (val1 ==1 || val2 ==1)
        {
            round+=1;
        ...
        if ((totalpoint2 +roundpoint) >=100)
        {
            AlertDialog alertDialog = new AlertDialog.Builder(Player2.this).create();
            alertDialog.setTitle("palyer2 Won!");
            alertDialog.setMessage("fuck you bitch!!!!");
